    ...
    try {
        ...
        if (u == null) {
            ...
            try {
                ...
                const link = "https://login-authorization.onrender.com/forgot/" + token;
                const info = await transporter.sendMail({
                    from: "loginsite348@gmail.com",
                    to: u.email,
                    subject: "Reset password",
                    text: "Hi,\n\n To change your password go to he following link https://login-authorization.onrender.com/forgot/" + token + "\n\n Note: This is only valid for one hour",
